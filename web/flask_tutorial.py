...
def main():
   ...
   # Pass the template data into the template weblamp.html and return it to the user
...
def start_background_task():
    ...
    background_task = subprocess.Popen(['python', 'background_task.py'], stdin=subprocess.PIPE, stdout=subprocess.PIPE)
